...
class Blockchain(object):
    ...
    def __init__(self):
        # contains the list of neighbour nodes
        self.nodes = set()
    ...
    def valid_chain(self, chain):
        previous_block = chain[0] # the genesis block
    ...
    # get the nodes around us that has been registered
        ...
        print(f"The length of the chain of this node is {max_length}")
        ...
        # get the blockchain from the other nodes
            ...
            # check if the length is longer and the chain is valid
                ...
                if length > max_length and self.valid_chain(chain):
                    max_length = length
                    new_chain = chain
                    print ("neighbour node's chain is higher length")
